...
# Nombres de imagen
IMAGE_NAME="$DOCKER_USERNAME/img_kuntur_detector_server"
...
docker run --name test-container -p 9000:8000 -d "$FULL_IMAGE_NAME"
...
echo ""
echo "Para usar:"
echo "  docker run -p 9000:8000 $FULL_IMAGE_NAME"
echo ""
echo "URLs:"
